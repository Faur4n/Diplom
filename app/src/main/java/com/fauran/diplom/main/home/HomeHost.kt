...
//    data class UserDetails(val user: User) : HomeScreen()
...
//        BottomNavigation() {
//            ///home
//            BottomNavigationItem(selected = screen == HomeScreen.Home, onClick = {
//                navigationViewModel.navigateHome()
//            },icon = {
//                val paint = rememberVectorPainter(image = Icons.Default.Home)
...
//                val user = state?.user
//                if (user != null) {
//                    RecommendationScreen(user, onDetailsClick = {
//                        navigationViewModel.navigateToUserDetails(user)
//                    }, onBackClick = {
//                        navigationViewModel.navigateHome()
//                    })
//                }
